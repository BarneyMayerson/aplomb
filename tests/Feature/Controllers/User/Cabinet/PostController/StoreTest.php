...
beforeEach(function () {
    $this->validData = [
        'title' => 'Hello there',
        'body' => "WHAT are you?' said the King, 'or I'll have you executed on the trumpet, and then sat upon it.) 'I'm glad they've begun asking riddles.--I believe I can remember feeling a little of her or of.",
    ];
});
